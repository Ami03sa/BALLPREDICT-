    ...
    playerProjections: data.player_projections.map((player: any) => ({
      ...
      projectedStats: {
        mean: {
          ...
          steals: player.projected_stats.mean.steals ?? 0,
          blocks: player.projected_stats.mean.blocks ?? 0,
    ...
    projection: {
      ...
      projectedStats: {
        mean: {
          ...
          steals: data.projection.projected_stats.mean.steals ?? 0,
          blocks: data.projection.projected_stats.mean.blocks ?? 0,
